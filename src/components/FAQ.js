...
const FAQ = ({ isOpen, onClose }) => {
  ...
  return <div className={className}>
    ...
    <p>
      This map shows{' '}
      <a href="https://docs.google.com/spreadsheets/d/1tZq47h6jg7NX4ddhTS_H8JFVfLZiDbxwwdQD47_ow64/edit#gid=842368430">Watsi's donations</a>
      {' '}in the selected month, grouped by countries. For each country, the size of its blue circle is correlated to the number of patients and the opacity to the amount of donation.
      <br/>
